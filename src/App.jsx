    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="py-12 sm:py-16 bg-white" id="about">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-3 text-sm text-zinc-700">Our mission is to make expert advice accessible to everyone. We connect you with verified professionals from various fields—career, finance, health, legal, wellness, travel, and more—so you can get a trusted second opinion before making important life decisions.</p>
      ...
      {/* Contact & Policies moved to footer */}
